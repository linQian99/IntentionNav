...
# All paths are relative to the project root. Override downloaded benchmark
# data and third-party scene assets with the documented environment variables.
...
# External third-party scene assets.
